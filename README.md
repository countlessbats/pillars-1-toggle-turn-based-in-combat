...
3. Double-click **install.bat**. It auto-detects your Steam install; if it can't, paste the game
   folder when asked — quotes are optional and paths with spaces or parentheses are fine
